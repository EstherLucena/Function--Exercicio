...
const letraM = strings1.filter((letra) => letra.charAt(0)=='M');
...
const soma = notasAluno.reduce((cont, valor) => cont + valor, 0);
const media = soma / notasAluno.length;
console.log(media); 

const alunosAprovados = notasAluno.filter((note) => note >= 7) ;
